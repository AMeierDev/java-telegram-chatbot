...
public class InitArticles
{
	...
	public synchronized static void initArtikels(final HertlBotRootDao dao)
	{
		...
		artikelList.add(new HertlBotArticle(1, "1/2-Hähnchen", BigInteger.valueOf(520L)));
		artikelList.add(new HertlBotArticle(2, "Hähnchen-Schenkel", BigInteger.valueOf(300L)));
		artikelList.add(new HertlBotArticle(3, "Krautsalat", BigInteger.valueOf(220L)));        
        ...
        artikelList.add(new HertlBotArticle(6, "Kartoffelsalat-Essig-Öl", BigInteger.valueOf(220L)));
        artikelList.add(new HertlBotArticle(7, "Kartoffelsalat-Majo", BigInteger.valueOf(220L)));
